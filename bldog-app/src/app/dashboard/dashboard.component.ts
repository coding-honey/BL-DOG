...
import { InformationService } from 'app/shelter/information.service';
import { ActivatedRoute, Router } from '@angular/router';
import Business from 'app/shelter/Business';
import { BusinessService } from 'app/shelter/business.service';
import {  AnimalListService } from '../animal-managements/animal-list/animal-list.service'
...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  constructor(private route: ActivatedRoute, private servicePet: AnimalListService,
    private router: Router,
    private is: InformationService, private bs: BusinessService,
    fb: FormBuilder) {
