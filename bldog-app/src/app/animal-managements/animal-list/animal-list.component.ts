...
@Component({
  ...
  providers:[AnimalListService, GuardianService ]
})
export class AnimalListComponent implements AfterViewInit, OnInit {
  ...
  private selectedPetSerial : String;


  constructor(public servicePet: AnimalListService , fb: FormBuilder,public serviceGuardian: GuardianService, fb2: FormBuilder) {
  ...
  initData(){
    ...
    this.getPrototypeData("001",20190101,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AA","AAA");

    this.getPrototypeData("002",20180105,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AD","AAA");

    this.getPrototypeData("003",20190110,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," "," ","AAA");

    this.getPrototypeData("004",20190201,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AA","AAA");

    this.getPrototypeData("005",20190205,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AD","AAA");

    this.getPrototypeData("006",20190210,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," "," ","AAA");

    this.getPrototypeData("007",20190301,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AD","AAA");

    this.getPrototypeData("008",20190305,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AA","AAA");

    this.getPrototypeData("009",20190310,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," ","AD","AAA");

    this.getPrototypeData("010",20190401,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","protect","dog"," ","brown"," "," ","AAA");

    //////////////////////////////////////////////

    this.getPrototypeData("011",20190101,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-10","AB","AAA");

    this.getPrototypeData("012",20190105,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-10","AC","AAA");

    this.getPrototypeData("013",20190110,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-10","AB","AAA");

    this.getPrototypeData("014",20190201,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-14","AB","AAA");

    this.getPrototypeData("015",20190205,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-14","AC","AAA");

    this.getPrototypeData("016",20190210,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-05-14","AB","AAA");

    this.getPrototypeData("017",20190301,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-10-18","AB","AAA");

    this.getPrototypeData("018",20190305,"shih-tzu",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-10-18","AC","AAA");

    this.getPrototypeData("019",20190310,"Border-collie",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-10-18","AB","AAA");

    this.getPrototypeData("020",20190401,"poodle",
    "kyeonggido","kimkozi",14,"boy","5kg",
    "good","nose","unProtected","dog"," ","brown","19-10-18","AB","AAA");
  ...
  //초기데이터 생성하는 함수
  getPrototypeData(ps:string,od:number,k:string,da:string,
    n:string,a:number,g:string,w:string,hs:string,d:string,
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.servicePet.getAllByStatusProtect("AAA") //getAll() //
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    console.log("this name : "+this.name.value+" password : "+this.kind.value);
  ...
  //선택된 동물에 가디언을 새로만들고 추가한다.
  addGuardian(form: any): Promise<any> {
    console.log("addGuardian 버튼 눌렸다.");
    this.asset = {
