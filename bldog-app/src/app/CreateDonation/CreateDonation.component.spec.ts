...
import { CreateDonationComponent } from './CreateDonation.component';
...
describe('CreateDonationComponent', () => {
  ...
  let mockCreateDonationService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateDonationService = sinon.createStubInstance(CreateDonationService);
    mockCreateDonationService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateDonationService, useValue: mockCreateDonationService },
