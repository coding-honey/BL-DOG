...
export class TradeComponent implements OnInit {
  ...
  newShelter = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      ...
      'pet': this.pet.value,
      'newShelter': this.newShelter.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.newShelter) {
        formObject.newShelter = result.newShelter;
      } else {
        formObject.newShelter = null;
      }
